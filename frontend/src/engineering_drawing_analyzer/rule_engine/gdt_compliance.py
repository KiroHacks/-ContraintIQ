...
_STANDARD_GDT_SYMBOLS_UNICODE: frozenset[str] = frozenset(
    {
        ...
        "↗",   # circular runout
        "⇗",   # total runout
        "↗↗",  # total runout (alternate encoding)
    }
)
            ...
            if not _is_standard_symbol(fcf.gdt_symbol):
                issues.append(
                    Issue(
                        ...
                        standard_reference="ASME Y14.5-2018 §3",
                    )
                )
                ...
                issues.append(
                    Issue(
                        ...
                        description=(
                            ...
                            "frame per ASME Y14.5-2018 §11.10."
                        ),
                        location=fcf.location,
                        corrective_action=(
                            ...
                            "FRTZF tolerance zone.  Refer to ASME Y14.5-2018 §11.10 "
                            "for the correct composite FCF format."
                        ),
                        standard_reference="ASME Y14.5-2018 §11.10",
                    )
                )
            ...
            if not datum.feature_id:
                issues.append(
                    Issue(
                        ...
                        corrective_action=None,
                        standard_reference="ASME Y14.5-2018 §4.5",
                    )
                )
                continue
